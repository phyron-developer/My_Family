<?php
    ...
    if($_SERVER['REQUEST_METHOD']=='GET'){
        ...
        $sql = "SELECT * FROM grud_database WHERE id = $id";
        $res = $cn -> query($sql);
        $row = $res->fetch_assoc();
        ...
        $sql = "UPDATE grud_database SET  name = '$name', age=$age, position ='$position' WHERE id=$id";
        $res = $cn -> query($sql);
...
<body>
    <div class="contain">
        ...
        <form action="" method="post">
            ...
            <input type="text" placeholder="Enter id's employee..." name="id" id="id" value="<?php echo $id?>"><br>
            <label for="">NAME</label><br>
            <input type="text" placeholder="Enter name's employee..." name="name" id="name" value="<?php echo $name?>"><br>
            <label for="">AGE</label><br>
            <input type="text" placeholder="Enter age's employee..." name="age" id="age" value="<?php echo $age?>"><br>
            <label for="">POSITION</label><br>
            <input type="text" placeholder="Enter position's employee..." name="position" id="position" value="<?php echo $position?>"><br>
            <button id="btn-add" type="submit">Edit</button>
        </form>
    </div>
